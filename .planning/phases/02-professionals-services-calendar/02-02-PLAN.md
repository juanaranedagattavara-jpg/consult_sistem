...
services: defineTable({
  ...
  preAppointmentInstructions: v.optional(v.string()), // SERV-03: Instructions for patient before appointment
...
- services.preAppointmentInstructions: SERV-03 optional patient instructions
...
- services table: all fields from CONTEXT.md including preAppointmentInstructions (SERV-03) + by_clinic, by_category, by_clinic_active indexes
