      ...
      <AlertDialog open={showDisconnect} onOpenChange={setShowDisconnect}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ¿Estas seguro de desconectar el calendario de {professionalName}?
...
Note: Per CONTEXT.md, the actual calendar list comes from n8n webhook that has OAuth. This component uses mock data that will be replaced when n8n integration is fully wired.
  </action>
